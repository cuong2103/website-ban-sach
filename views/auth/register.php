...
<body
    class="h-full bg-gradient-to-br from-green-50 via-white to-green-100 flex items-center justify-center min-h-screen py-8">
            ...
            <form action="<?= BASE_URL ?>?act=check-register" method="POST" class="space-y-4" novalidate>
                ...
                <div class="flex items-start gap-3 pt-2">
                    ...
                    <label for="terms" class="text-sm text-gray-600">
                        Tôi đồng ý với <a href="#" class="text-[#4CAF50] font-medium hover:underline">Điều khoản dịch vụ
