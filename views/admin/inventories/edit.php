...
// Nếu không có old data, lấy từ $inventory
if (empty($old)) {
    $old = [
        'stock_quantity' => $inventory['stock_quantity'] ?? 0,
        'imported_quantity' => $inventory['imported_quantity'] ?? 0
    ];
}
?>
...
<head>
    ...
    <title>Sửa Kho Hàng | Admin</title>
...
<body>
    <div class="container">
        ...
        <div class="form-section">
            <h2
                style="margin-top: 0; color: #333; font-size: 16px; border-bottom: 2px solid #FF6B35; padding-bottom: 10px;">
                Thông Tin Sách
            </h2>
            <div class="book-info">
                <p>
                    <span class="label">ID Sách:</span>
                    <?php echo $inventory['book_id']; ?>
                </p>
                <p>
                    <span class="label">Tên Sách:</span>
                    <?php echo htmlspecialchars($inventory['title']); ?>
                </p>
                <p>
                    <span class="label">Tác Giả:</span>
                    <?php echo htmlspecialchars($inventory['author']); ?>
                </p>
                <p>
                    <span class="label">Danh Mục:</span>
                    <?php echo htmlspecialchars($inventory['category_name'] ?? 'N/A'); ?>
                </p>
                <p>
                    <span class="label">Giá:</span>
                    <?php echo number_format($inventory['price']); ?>₫
                </p>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>admin-inventories-update">
                ...
                <div class="form-group <?php echo isset($validationErrors['stock_quantity']) ? 'error' : ''; ?>">
                    ...
                    <input type="number" id="stock_quantity" name="stock_quantity"
                        value="<?php echo $old['stock_quantity']; ?>" min="0" placeholder="Nhập số lượng" required>
                ...
                <div class="form-group <?php echo isset($validationErrors['imported_quantity']) ? 'error' : ''; ?>">
                    ...
                    <input type="number" id="imported_quantity" name="imported_quantity"
                        value="<?php echo $old['imported_quantity']; ?>" min="0" placeholder="Nhập số lượng" required>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-submit">Cập Nhật Kho Hàng</button>
