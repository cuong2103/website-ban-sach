                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="author" list="author_list" value="<?= old('author', $book['author']) ?>"
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="10"
                                      class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#4CAF50]/20 focus:border-[#4CAF50] transition-colors"><?= old('description', $book['description']) ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="sale_price" id="sale_price" value="<?= old('sale_price', $book['sale_price']) ?>"
                                   class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#4CAF50]/20 focus:border-[#4CAF50] transition-colors">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                    ...
                    <div>
                        <div class="mt-1 flex justify-center border-2 border-gray-300 border-dashed rounded-xl relative hover:bg-gray-50 transition-colors overflow-hidden aspect-square w-full max-w-[200px] mx-auto">
                            <label for="thumbnail" id="thumbnail-upload-container" class="w-full h-full cursor-pointer <?= $book['thumbnail'] ? 'hidden' : 'flex' ?> flex-col items-center justify-center p-6">
                            ...
                            <div id="thumbnail-preview" class="<?= $book['thumbnail'] ? '' : 'hidden' ?> absolute inset-0 z-10 bg-white">
                                <img src="<?= $book['thumbnail'] ? htmlspecialchars(BASE_URL . $book['thumbnail']) : '' ?>" alt="Preview" class="w-full h-full object-cover">
                                <div class="absolute inset-0 bg-black/40 opacity-0 hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <button type="button" id="thumbnail-remove" class="bg-red-500 text-white p-3 rounded-full hover:bg-red-600 transition-colors shadow-sm cursor-pointer z-20" title="Bỏ chọn ảnh / Xóa ảnh">
                                        <i data-lucide="x" class="w-6 h-6"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                        <!-- Hidden input báo server xóa ảnh cũ khi bấm X -->
...
<script>        
    ...
    thumbnailInput.addEventListener('change', function(e) {
        document.getElementById('delete_thumbnail').value = '0'; // hủy yêu cầu xóa khi chọn ảnh mới
    ...
    thumbnailRemove.addEventListener('click', function() {
        ...
        document.getElementById('delete_thumbnail').value = '1'; // báo server xóa ảnh cũ
    });
    ...
    galleryInput.addEventListener('change', function(e) {
        // Xóa các ảnh mới đã preview trước đó
        const newItems = galleryContainer.querySelectorAll('.new-gallery-item');
